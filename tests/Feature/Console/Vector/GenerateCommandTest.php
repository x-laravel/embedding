...
class GenerateCommandTest extends TestCase
{
    public function test_generates_missing_embeddings_by_default(): void
    {
        ...
        $this->artisan('embedding:vector:generate', ['model' => Article::class])
    ...
    public function test_regenerates_all_with_force_option(): void
    {
        ...
        $this->artisan('embedding:vector:generate', ['model' => Article::class, '--force' => true])
    ...
    {
        $this->artisan('embedding:vector:generate', ['model' => 'App\Models\NonExistent'])
    ...
    {
        $this->artisan('embedding:vector:generate', ['model' => \Illuminate\Database\Eloquent\Model::class])
